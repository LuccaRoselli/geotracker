...
include 'controllers/php_password_edit.php';
...
<body>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    <div class="page-header-title">
                                        <h5 class="m-b-10">Editando sua senha</h5>
                                    </div>
                                    <ul class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="index"><i
                                                    class="feather icon-home"></i></a></li>
                                        <li class="breadcrumb-item"><a href="javascript:">Editando sua senha</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>"
                                                        ...
                                                        <div class="input-group mb-4"
                                                            ...
                                                            <input type="password" class="form-control"
                                                                name="passwordInput" placeholder="Senha...">
                                                        </div>
    ...
    <script>
    toastr.info('Você precisa alterar sua senha por ser o primeiro login.', 'Atenção');
    </script>
    <?php endif; ?>
